...
export default function TransactionList({ transactions }) {
  return (
    <div className="w-full p-4 bg-gray-100 shadow-lg rounded-lg mt-10">
        ...
        <Table className="w-full  border border-gray-200 rounded-lg">
          <TableHeader>
            <TableRow className="bg-gray-100">
              ...
              <TableHead className="p-2 text-right">Amount (Rs.)</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {transactions.map((txn) => (
              <TableRow key={txn._id} className="border-b border-gray-200 hover:bg-gray-50">
                ...
                <TableCell className="p-2 text-right font-medium">Rs.{txn.amount}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
